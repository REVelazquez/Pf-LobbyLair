...
const Profile = () => {
  ...
  if(userDetail.id == id){
    return (
    <div className="m-10">
    <div className="bg-gray-300 rounded-lg relative h-[15rem]" style={{
      ...
      <div className="flex items-center">
        ...
        <div className="flex flex-col space-y-2 w-full">
          <div className="mb-1 my-10">
            <h3 className="text-4xl font-bold text-left m-2 p-3 truncate border-b border-black w-2/2">{userDetail.name}</h3>
          </div>
          <div className="inline-flex">
            ...
            <div className="m-4 space-x-2 pl-10">
              ...
              <h1 className="text-black truncate">{userDetail.createdAt.slice(0, 10).split('-').reverse().join('-')}</h1>
            </div>
            <div className="m-4 space-x-2 pl-10">
              <h1 className="text-black font-bold truncate">Profile Url:</h1>
              <h1 className="text-black truncate">{userDetail.perfilUrl !== '' ? userDetail.perfilUrl : 'You can put a steam profile url or similar'}</h1>
            </div>
          </div>
        </div>
      </div>

    ...
    <div className="flex ml-[15rem] my-[5rem]">
      ...
      <div>
        <form style={{ marginTop: "0.75em" }} onSubmit={handleSubmit}>
          ...
          />
          <button
            className="m-2 bg-black text-white border-none rounded-[5rem] p-3 text-l font-bold cursor-pointer"
            type="submit"
          >
            Crear Post
          </button>
        ...
        <button
          onClick={handlePrev}
          disable={btnPrev}
          className="bg-black text-white border-none rounded-[5rem] p-3 text-l font-bold cursor-pointer m-2"
        >
          {" "}
          Prev{" "}
        </button>
          ...
          {pagedPosts?.map(({ id, createdAt, text, User }) => {
            if (User) {
              return (
                <div
                  key={id}
                  className="items-center justify-center w-[300px] h-[110px] mx-auto my-[5rem] bg-gray-300 rounded-lg p-3 ml-[10rem]"
                  style={{
                    boxShadow: "0 2px 10px rgba(0, 0, 0, 0.25)",
                  }}
                >
